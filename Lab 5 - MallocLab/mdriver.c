...
int main(int argc, char **argv)
{
    ...
    float points = (((p1 + p2) - MM_IMPLICIT_THRESHOLD) / (MM_EXPLICIT_THRESHOLD - MM_IMPLICIT_THRESHOLD))*35.0;
    points = (points < 0)? 0 : points;

    printf("Total: %0.f/35 (threshold-ed at %0.f, normalized to %0.f, and scaled to 35.0 points)\n", points, MM_IMPLICIT_THRESHOLD*100, MM_EXPLICIT_THRESHOLD*100);
